...
### N2: Names Don't Belong Together
...
- Name feels harsh → add flow sounds (l, r, vowels) or soften consonants
- Name feels weak → add power sounds (k, t, p) or shorten syllables
- Name feels generic → add distinctive phoneme or unusual combination
- Name feels foreign → shift toward high-frequency English phonemes
- Name feels dated → check category conventions; update to current patterns
