...
| [`empire-git`](plugins/empire-git/README.md)           | Git workflow: parallel worktree lifecycle (`open`, `close`, `merge`, `list`, `cleanup`, `help`), `pr-description` templating, and stacked-PR `pr-stack`/`pr-merge`. |
